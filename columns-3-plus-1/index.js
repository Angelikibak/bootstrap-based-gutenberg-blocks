...
class ThreeColumnsBlock extends Component {
    constructor() {
        super(...arguments);
    }
    ...
    render() {
        ...
        const setTemplate = [
            [ 'holviblocks/column', { columnWidth : 'col-12 col-md-4', padding: true } ],
            [ 'holviblocks/column', { columnWidth : 'col-12 col-md-4', padding: true } ],
            [ 'holviblocks/column', { columnWidth : 'col-12 col-md-4', padding: true } ],
            [ 'holviblocks/column', { columnWidth : 'col-12 col-md-12', padding: true } ],
        ];
        ...
        return ([
            ...
            <section
                ...
                className={ classnames(
                    className,
                    'section-padding position-relative col-3-1',
...
export default registerBlockType(
    'holviblocks/columns-3-plus-1',
    {
        title: __( 'Columns 3 + 1', 'holviblocks' ),
        description: __( 'Create three columns layout', 'holviblocks' ),
