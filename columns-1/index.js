...
class OneColumnsBlock extends Component {
    ...
    render() {
        ...
        const setTemplate = [
            [ 'holviblocks/column', { columnWidth : 'col-12', padding: true } ],
        ];
        ...
        return ([
            <InspectorControls>
                ...
                <PanelBody title={ __( "Column Settings" ) } initialOpen={ false }>
                    ...
                    <PanelRow>
                        <strong>Make the width smaller desktop</strong>
                        <ToggleControl
                            checked={ desktopWidth }
                            onChange={desktopWidth => setAttributes({ desktopWidth })}
                        />
                    </PanelRow>
                    <PanelRow>
...
export default registerBlockType(
    'holviblocks/columns-1',
    {
        title: __( 'Columns 1', 'holviblocks' ),
        description: __( 'Create a one column layout', 'holviblocks' ),
